...
replace id1=100 if id1==9
replace id1=9 if id1==10
replace id1=10 if id1==100

replace id1=100 if id1==17
replace id1=17 if id1==18
replace id1=18 if id1==100
...
drop gap* n* 
drop def2_01 def2_02

gen year=1970

save "`output'\se\rifreg_7080_det.dta", replace

texsave using "$tables/det_results_7080.tex", title(Detailed decomposition results: 1978/79 - 1985/86)	///
marker (results_70) varlabels replace frag
